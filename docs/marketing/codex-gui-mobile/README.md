...
- `Codex-GUI-mobile-1080p.mp4`：1920×1080，30 fps，H.264 / AAC，约 85 秒，内嵌中文字幕。
...
第二版删除了片头和第八章中介绍录制设备的文字、配音及字幕；对应旁白、字幕时间线和投稿简介已同步更新。另存 `Codex-GUI-mobile-1080p-v2.mp4` 便于区分修订版本。
