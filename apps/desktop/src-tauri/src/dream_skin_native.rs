...
const BUILT_IN_THEME_IDS: [&str; 257] = [
    ...
    "preset-nature-alpine-glow",
    "preset-nature-granite-crown-mist",
    "preset-nature-emerald-canyon-river",
    "preset-nature-red-rock-chasm",
    "preset-nature-patagonian-spires-dawn",
    "preset-nature-northern-basalt-falls",
    "preset-nature-angel-veil-cliff",
    "preset-nature-jade-cloudforest-falls",
    "preset-nature-snowpeak-moonrise",
    "preset-nature-volcanic-caldera-dawn",
    "preset-nature-karst-ridge-rain",
    "preset-nature-highland-heather-valley",
    "preset-nature-sandstone-arches-sunrise",
    "preset-nature-blue-glacier-valley",
    "preset-nature-jade-terrace-waterfall",
    "preset-nature-altiplano-lagoon",
    "preset-nature-fjord-cliff-waterfalls",
    "preset-nature-rhododendron-snow-pass",
    "preset-nature-mesa-thunderstorm",
    "preset-nature-marble-gorge-river",
    "preset-nature-aurora-mountain-lake",
    "preset-nature-desert-canyon-stars",
    "preset-nature-autumn-alpine-valley",
    "preset-nature-rainbow-mist-falls",
    "preset-nature-cloud-sea-plateau",
    "preset-nature-azure-archipelago",
    "preset-nature-basalt-tidepools",
    "preset-nature-coral-lagoon",
    "preset-nature-mangrove-dawn",
    "preset-nature-alpine-mirror-lake",
    "preset-nature-glacial-fjord",
    "preset-nature-river-canyon",
    "preset-nature-moonlit-estuary",
    "preset-nature-kelp-cathedral",
    "preset-nature-ocean-blue-hole",
    "preset-nature-limestone-cenote",
    "preset-nature-braided-delta",
    "preset-nature-willow-backwater",
    "preset-nature-tufa-lake",
    "preset-nature-silver-salt-marsh",
    "preset-nature-sea-cave-light",
    "preset-nature-volcanic-island-bay",
    "preset-nature-lotus-wetland",
    "preset-nature-cloudforest-cascade",
    "preset-nature-turquoise-atoll",
    "preset-nature-arctic-polynya",
    "preset-nature-cypress-swamp",
    "preset-nature-desert-river-sandbar",
    "preset-nature-underwater-ridge",
    "preset-nature-bioluminescent-shore",
    "preset-nature-emerald-fern-ravine",
    "preset-nature-misty-redwood-morning",
    "preset-nature-birch-grove-sunshower",
    "preset-nature-ancient-moss-cedars",
    "preset-nature-luminous-beech-autumn",
    "preset-nature-alpine-meadow-dawn",
    "preset-nature-windswept-pampas-sunset",
    "preset-nature-bluebell-woodland",
    "preset-nature-lavender-field-twilight",
    "preset-nature-wildflower-riverbend",
    "preset-nature-rapeseed-hills-spring",
    "preset-nature-coastal-tulip-breeze",
    "preset-nature-heather-moor-sunrise",
    "preset-nature-camellia-garden-rain",
    "preset-nature-sunflower-valley-evening",
    "preset-nature-cherry-orchard-mist",
    "preset-nature-maple-glade-first-frost",
    "preset-nature-summer-oak-pasture",
    "preset-nature-winter-pine-clearing",
    "preset-nature-spring-tea-terraces",
    "preset-nature-golden-wheat-breeze",
    "preset-nature-clover-meadow-rainbow",
    "preset-nature-dandelion-downs-morning",
    "preset-nature-cosmos-flower-sea",
    "preset-nature-apple-orchard-after-rain",
    "preset-nature-aurora-icefjord",
    "preset-nature-polar-blue-hour",
    "preset-nature-glacier-crystal-cave",
    "preset-nature-snowfield-moonrise",
    "preset-nature-iceberg-dawn",
    "preset-nature-sahara-star-dunes",
    "preset-nature-namib-sunrise",
    "preset-nature-white-desert-moon",
    "preset-nature-salt-flat-mirror",
    "preset-nature-desert-oasis-dusk",
    "preset-nature-volcanic-lava-night",
    "preset-nature-sulfur-fumarole-valley",
    "preset-nature-prismatic-geyser-basin",
    "preset-nature-yardang-stormlight",
    "preset-nature-limestone-cathedral-cave",
    "preset-nature-frozen-lake-bubbles",
    "preset-nature-prairie-supercell",
    "preset-nature-monsoon-double-rainbow",
    "preset-nature-milky-way-savanna",
    "preset-nature-eclipse-plateau",
    "preset-nature-perseid-tundra",
    "preset-nature-noctilucent-river",
    "preset-nature-frost-sun-pillar",
    "preset-nature-desert-superbloom",
    "preset-nature-mammatus-afterglow",
    "preset-neon-orbital-citadel",
    "preset-cryo-moon-harbor",
    "preset-quantum-desert-relay",
    "preset-bioluminescent-star-garden",
    "preset-void-sail-observatory",
    "preset-titan-methane-foundry",
    "preset-aurora-dyson-bloom",
    "preset-mars-glass-canyon",
    "preset-pulsar-archive",
    "preset-europa-subsea-beacon",
    "preset-cybernetic-monsoon-city",
    "preset-solar-wind-monastery",
    "preset-antimatter-cathedral",
    "preset-cobalt-warp-gate",
    "preset-lunar-rice-terrace",
    "preset-singularity-lighthouse",
    "preset-comet-caravan",
    "preset-exoplanet-cloud-port",
    "preset-nebula-forge",
    "preset-dark-matter-orchard",
    "preset-chrome-forest-sentinel",
    "preset-porcelain-android-dawn",
    "preset-mech-jellyfish-trench",
    "preset-repair-drone-sanctuary",
    "preset-quantum-fox-companion",
    "preset-starship-drydock-zero",
    "preset-ion-sail-regatta",
    "preset-generation-ship-atrium",
    "preset-stealth-corvette-eclipse",
    "preset-asteroid-mining-barge",
    "preset-crystal-spore-valley",
    "preset-floating-coral-moon",
    "preset-plasma-whale-migration",
    "preset-silicon-bamboo-grove",
    "preset-gravity-lily-lagoon",
    "preset-chrono-station-echo",
    "preset-retrocausal-library",
    "preset-last-minute-of-earth",
    "preset-temporal-tea-house",
    "preset-aeon-clockwork-plain",
    "preset-neutrino-lab-night",
    "preset-holographic-botany-deck",
    "preset-fusion-core-sanctum",
    "preset-xenobiology-greenhouse",
    "preset-quantum-computing-vault",
    "preset-clean-energy-megacity",
    "preset-ocean-skybridge",
    "preset-orbital-agriculture-ring",
    "preset-lunar-library-plaza",
    "preset-terraformed-venus-garden",
    "preset-acid-rain-data-bazaar",
    "preset-abandoned-moon-metro",
    "preset-red-signal-quarantine",
    "preset-ashfall-server-farm",
    "preset-blackout-megacity",
    "preset-photosynthetic-tower",
    "preset-sunlit-robot-village",
    "preset-algae-canal-district",
    "preset-wind-harvester-steppe",
    "preset-seedship-nursery",
    "preset-atomic-age-space-lounge",
    "preset-cassette-cosmos-console",
    "preset-analog-mission-control",
    "preset-chrome-rocket-motel",
    "preset-vacuum-tube-star-map",
    "preset-event-horizon-ribbons",
    "preset-gravitational-wave-sea",
    "preset-quantum-foam-cavern",
    "preset-photon-prism-temple",
    "preset-entangled-light-garden",
    "preset-orbital-rescue-wing",
    "preset-frontier-peacekeeper-outpost",
    "preset-asteroid-defense-grid",
    "preset-humanitarian-mech-convoy",
    "preset-deep-space-searchlight",
    "preset-jade-orbit-palace",
    "preset-neon-changan-station",
    "preset-celestial-silk-road",
    "preset-moon-rabbit-rover",
    "preset-red-lantern-starport",
    "preset-abyssal-data-center",
    "preset-submarine-city-dawn",
    "preset-hydrothermal-research-rig",
    "preset-ocean-planet-arcology",
    "preset-tidal-energy-cathedral",
    "preset-polar-aurora-array",
    "preset-icebound-robot-caravan",
    "preset-cryogenic-seed-vault",
    "preset-glacier-quantum-lab",
    "preset-snowfield-sky-elevator",
    "preset-first-contact-horizon",
    "preset-alien-megastructure-dusk",
    "preset-silent-radio-telescope",
    "preset-ancient-probe-awakening",
    "preset-interstellar-ruin-garden",
    "preset-spaceship-window-cafe",
    "preset-moonbase-reading-nook",
    "preset-robot-workshop-evening",
    "preset-orbital-rainy-bedroom",
    "preset-starlight-noodle-stall",
];
