...
fn validate_totp_tombstone(tombstone: &CloudTotpTombstone) -> Result<(), String> {
...
mod tests {
    ...
    fn totp_vault_validation_rejects_invalid_tombstones() {
        ...
        assert!(
            validate_totp_vault(&[valid_totp_entry()], &[tombstone], "2026-08-15T10:00:01Z",)
                .is_err()
        );
    }
