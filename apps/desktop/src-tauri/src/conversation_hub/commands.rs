...
pub(crate) async fn browse_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        browse_codex_threads_blocking(
            ThreadContext::new(app, home_id)?,
            title_query,
            content_query,
        )
    })
...
pub(crate) async fn measure_codex_thread_tokens<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        measure_codex_thread_tokens_blocking(ThreadContext::new(app, home_id)?, session_ids)
    })
    .await
...
pub(crate) async fn discard_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        discard_codex_threads_blocking(ThreadContext::new(app, home_id)?, session_ids)
    })
    .await
...
pub(crate) async fn browse_codex_thread_bin<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        browse_codex_thread_bin_blocking(ThreadContext::new(app, home_id)?)
    })
    .await
...
pub(crate) async fn purge_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        purge_codex_threads_blocking(ThreadContext::new(app, home_id)?, session_ids)
    })
    .await
...
pub(crate) async fn empty_codex_thread_bin<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        empty_codex_thread_bin_blocking(ThreadContext::new(app, home_id)?)
    })
    .await
...
pub(crate) async fn inspect_codex_thread_export<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        inspect_codex_thread_export_blocking(ThreadContext::new(app, home_id)?, session_ids)
    })
    .await
...
pub(crate) async fn pack_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        pack_codex_threads_blocking(ThreadContext::new(app, home_id)?, session_ids, export_path)
    })
    .await
...
pub(crate) async fn inspect_codex_thread_import<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        inspect_codex_thread_import_blocking(ThreadContext::new(app, home_id)?, import_path)
    })
    .await
...
pub(crate) async fn unpack_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        unpack_codex_threads_blocking(ThreadContext::new(app, home_id)?, import_path, session_ids)
    })
    .await
...
pub(crate) async fn migrate_codex_threads<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        migrate_codex_threads_blocking(ThreadContext::new(app, home_id)?, session_ids)
    })
    .await
...
pub(crate) async fn reconcile_codex_thread_visibility<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        let context = ThreadContext::new(app, request.home_id)?;
        reconcile_codex_thread_visibility_blocking(
            context,
            request.mode,
            request.session_ids,
            request.dry_run,
...
pub(crate) async fn rebuild_codex_thread_index<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        rebuild_codex_thread_index_blocking(ThreadContext::new(app, home_id)?)
    })
    .await
...
pub(crate) async fn open_codex_thread_file<R: Runtime + 'static>(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        open_codex_thread_file_blocking(ThreadContext::new(app, home_id)?, session_id, folder_only)
    })
    .await
